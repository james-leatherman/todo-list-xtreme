...
def get_auth_token():
    """Get auth token from environment variable (set by common auth system)"""
...
def test_column_settings_crud(auth_token=None):
...
def test_empty_column_persistence(auth_token=None):
...
def test_comprehensive_column_persistence(auth_token=None):
...
def test_blocked_column_functionality(auth_token=None):
...
if __name__ == "__main__":
    print("🧪 Running Column Tests with Common Authentication")
    print("==================================================")
    ...
    # Run all tests
    try:
        test_column_settings_crud(auth_token)
        test_empty_column_persistence(auth_token)
        test_comprehensive_column_persistence(auth_token)
        test_blocked_column_functionality(auth_token)
