...
echo "📁 Related Files:"
echo "================="
echo "- Frontend: frontend/src/pages/TodoList.js (lines ~860-890)"
echo "- Backend: frontend/src/pages/ColumnManager.js (restoreDefaultColumns method)"
echo "- API: backend/src/todo_api/api/v1/endpoints/column_settings.py"
